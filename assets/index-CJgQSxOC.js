(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const h of document.querySelectorAll('link[rel="modulepreload"]'))s(h);new MutationObserver(h=>{for(const c of h)if(c.type==="childList")for(const d of c.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function o(h){const c={};return h.integrity&&(c.integrity=h.integrity),h.referrerPolicy&&(c.referrerPolicy=h.referrerPolicy),h.crossOrigin==="use-credentials"?c.credentials="include":h.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(h){if(h.ep)return;h.ep=!0;const c=o(h);fetch(h.href,c)}})();function Bg(a){return a&&a.__esModule&&Object.prototype.hasOwnProperty.call(a,"default")?a.default:a}var Bu={exports:{}},br={};var Rm;function Zw(){if(Rm)return br;Rm=1;var a=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function o(s,h,c){var d=null;if(c!==void 0&&(d=""+c),h.key!==void 0&&(d=""+h.key),"key"in h){c={};for(var g in h)g!=="key"&&(c[g]=h[g])}else c=h;return h=c.ref,{$$typeof:a,type:s,key:d,ref:h!==void 0?h:null,props:c}}return br.Fragment=r,br.jsx=o,br.jsxs=o,br}var Bm;function Jw(){return Bm||(Bm=1,Bu.exports=Zw()),Bu.exports}var Z=Jw(),Ou={exports:{}},ge={};var Om;function Pw(){if(Om)return ge;Om=1;var a=Symbol.for("react.transitional.element"),r=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),h=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),d=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),w=Symbol.for("react.activity"),T=Symbol.iterator;function v(E){return E===null||typeof E!="object"?null:(E=T&&E[T]||E["@@iterator"],typeof E=="function"?E:null)}var N={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},H=Object.assign,R={};function B(E,q,k){this.props=E,this.context=q,this.refs=R,this.updater=k||N}B.prototype.isReactComponent={},B.prototype.setState=function(E,q){if(typeof E!="object"&&typeof E!="function"&&E!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,E,q,"setState")},B.prototype.forceUpdate=function(E){this.updater.enqueueForceUpdate(this,E,"forceUpdate")};function X(){}X.prototype=B.prototype;function V(E,q,k){this.props=E,this.context=q,this.refs=R,this.updater=k||N}var re=V.prototype=new X;re.constructor=V,H(re,B.prototype),re.isPureReactComponent=!0;var le=Array.isArray;function _(){}var J={H:null,A:null,T:null,S:null},ce=Object.prototype.hasOwnProperty;function fe(E,q,k){var P=k.ref;return{$$typeof:a,type:E,key:q,ref:P!==void 0?P:null,props:k}}function be(E,q){return fe(E.type,q,E.props)}function ee(E){return typeof E=="object"&&E!==null&&E.$$typeof===a}function $(E){var q={"=":"=0",":":"=2"};return"$"+E.replace(/[=:]/g,function(k){return q[k]})}var ke=/\/+/g;function ne(E,q){return typeof E=="object"&&E!==null&&E.key!=null?$(""+E.key):q.toString(36)}function G(E){switch(E.status){case"fulfilled":return E.value;case"rejected":throw E.reason;default:switch(typeof E.status=="string"?E.then(_,_):(E.status="pending",E.then(function(q){E.status==="pending"&&(E.status="fulfilled",E.value=q)},function(q){E.status==="pending"&&(E.status="rejected",E.reason=q)})),E.status){case"fulfilled":return E.value;case"rejected":throw E.reason}}throw E}function I(E,q,k,P,he){var oe=typeof E;(oe==="undefined"||oe==="boolean")&&(E=null);var Ee=!1;if(E===null)Ee=!0;else switch(oe){case"bigint":case"string":case"number":Ee=!0;break;case"object":switch(E.$$typeof){case a:case r:Ee=!0;break;case y:return Ee=E._init,I(Ee(E._payload),q,k,P,he)}}if(Ee)return he=he(E),Ee=P===""?"."+ne(E,0):P,le(he)?(k="",Ee!=null&&(k=Ee.replace(ke,"$&/")+"/"),I(he,q,k,"",function(qt){return qt})):he!=null&&(ee(he)&&(he=be(he,k+(he.key==null||E&&E.key===he.key?"":(""+he.key).replace(ke,"$&/")+"/")+Ee)),q.push(he)),1;Ee=0;var Ge=P===""?".":P+":";if(le(E))for(var He=0;He<E.length;He++)P=E[He],oe=Ge+ne(P,He),Ee+=I(P,q,k,oe,he);else if(He=v(E),typeof He=="function")for(E=He.call(E),He=0;!(P=E.next()).done;)P=P.value,oe=Ge+ne(P,He++),Ee+=I(P,q,k,oe,he);else if(oe==="object"){if(typeof E.then=="function")return I(G(E),q,k,P,he);throw q=String(E),Error("Objects are not valid as a React child (found: "+(q==="[object Object]"?"object with keys {"+Object.keys(E).join(", ")+"}":q)+"). If you meant to render a collection of children, use an array instead.")}return Ee}function F(E,q,k){if(E==null)return E;var P=[],he=0;return I(E,P,"","",function(oe){return q.call(k,oe,he++)}),P}function ie(E){if(E._status===-1){var q=E._result;q=q(),q.then(function(k){(E._status===0||E._status===-1)&&(E._status=1,E._result=k)},function(k){(E._status===0||E._status===-1)&&(E._status=2,E._result=k)}),E._status===-1&&(E._status=0,E._result=q)}if(E._status===1)return E._result.default;throw E._result}var ve=typeof reportError=="function"?reportError:function(E){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof E=="object"&&E!==null&&typeof E.message=="string"?String(E.message):String(E),error:E});if(!window.dispatchEvent(q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",E);return}console.error(E)},S={map:F,forEach:function(E,q,k){F(E,function(){q.apply(this,arguments)},k)},count:function(E){var q=0;return F(E,function(){q++}),q},toArray:function(E){return F(E,function(q){return q})||[]},only:function(E){if(!ee(E))throw Error("React.Children.only expected to receive a single React element child.");return E}};return ge.Activity=w,ge.Children=S,ge.Component=B,ge.Fragment=o,ge.Profiler=h,ge.PureComponent=V,ge.StrictMode=s,ge.Suspense=p,ge.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=J,ge.__COMPILER_RUNTIME={__proto__:null,c:function(E){return J.H.useMemoCache(E)}},ge.cache=function(E){return function(){return E.apply(null,arguments)}},ge.cacheSignal=function(){return null},ge.cloneElement=function(E,q,k){if(E==null)throw Error("The argument must be a React element, but you passed "+E+".");var P=H({},E.props),he=E.key;if(q!=null)for(oe in q.key!==void 0&&(he=""+q.key),q)!ce.call(q,oe)||oe==="key"||oe==="__self"||oe==="__source"||oe==="ref"&&q.ref===void 0||(P[oe]=q[oe]);var oe=arguments.length-2;if(oe===1)P.children=k;else if(1<oe){for(var Ee=Array(oe),Ge=0;Ge<oe;Ge++)Ee[Ge]=arguments[Ge+2];P.children=Ee}return fe(E.type,he,P)},ge.createContext=function(E){return E={$$typeof:d,_currentValue:E,_currentValue2:E,_threadCount:0,Provider:null,Consumer:null},E.Provider=E,E.Consumer={$$typeof:c,_context:E},E},ge.createElement=function(E,q,k){var P,he={},oe=null;if(q!=null)for(P in q.key!==void 0&&(oe=""+q.key),q)ce.call(q,P)&&P!=="key"&&P!=="__self"&&P!=="__source"&&(he[P]=q[P]);var Ee=arguments.length-2;if(Ee===1)he.children=k;else if(1<Ee){for(var Ge=Array(Ee),He=0;He<Ee;He++)Ge[He]=arguments[He+2];he.children=Ge}if(E&&E.defaultProps)for(P in Ee=E.defaultProps,Ee)he[P]===void 0&&(he[P]=Ee[P]);return fe(E,oe,he)},ge.createRef=function(){return{current:null}},ge.forwardRef=function(E){return{$$typeof:g,render:E}},ge.isValidElement=ee,ge.lazy=function(E){return{$$typeof:y,_payload:{_status:-1,_result:E},_init:ie}},ge.memo=function(E,q){return{$$typeof:m,type:E,compare:q===void 0?null:q}},ge.startTransition=function(E){var q=J.T,k={};J.T=k;try{var P=E(),he=J.S;he!==null&&he(k,P),typeof P=="object"&&P!==null&&typeof P.then=="function"&&P.then(_,ve)}catch(oe){ve(oe)}finally{q!==null&&k.types!==null&&(q.types=k.types),J.T=q}},ge.unstable_useCacheRefresh=function(){return J.H.useCacheRefresh()},ge.use=function(E){return J.H.use(E)},ge.useActionState=function(E,q,k){return J.H.useActionState(E,q,k)},ge.useCallback=function(E,q){return J.H.useCallback(E,q)},ge.useContext=function(E){return J.H.useContext(E)},ge.useDebugValue=function(){},ge.useDeferredValue=function(E,q){return J.H.useDeferredValue(E,q)},ge.useEffect=function(E,q){return J.H.useEffect(E,q)},ge.useEffectEvent=function(E){return J.H.useEffectEvent(E)},ge.useId=function(){return J.H.useId()},ge.useImperativeHandle=function(E,q,k){return J.H.useImperativeHandle(E,q,k)},ge.useInsertionEffect=function(E,q){return J.H.useInsertionEffect(E,q)},ge.useLayoutEffect=function(E,q){return J.H.useLayoutEffect(E,q)},ge.useMemo=function(E,q){return J.H.useMemo(E,q)},ge.useOptimistic=function(E,q){return J.H.useOptimistic(E,q)},ge.useReducer=function(E,q,k){return J.H.useReducer(E,q,k)},ge.useRef=function(E){return J.H.useRef(E)},ge.useState=function(E){return J.H.useState(E)},ge.useSyncExternalStore=function(E,q,k){return J.H.useSyncExternalStore(E,q,k)},ge.useTransition=function(){return J.H.useTransition()},ge.version="19.2.4",ge}var Nm;function fh(){return Nm||(Nm=1,Ou.exports=Pw()),Ou.exports}var L=fh(),Nu={exports:{}},vr={},Hu={exports:{}},ju={};var Hm;function $w(){return Hm||(Hm=1,(function(a){function r(I,F){var ie=I.length;I.push(F);e:for(;0<ie;){var ve=ie-1>>>1,S=I[ve];if(0<h(S,F))I[ve]=F,I[ie]=S,ie=ve;else break e}}function o(I){return I.length===0?null:I[0]}function s(I){if(I.length===0)return null;var F=I[0],ie=I.pop();if(ie!==F){I[0]=ie;e:for(var ve=0,S=I.length,E=S>>>1;ve<E;){var q=2*(ve+1)-1,k=I[q],P=q+1,he=I[P];if(0>h(k,ie))P<S&&0>h(he,k)?(I[ve]=he,I[P]=ie,ve=P):(I[ve]=k,I[q]=ie,ve=q);else if(P<S&&0>h(he,ie))I[ve]=he,I[P]=ie,ve=P;else break e}}return F}function h(I,F){var ie=I.sortIndex-F.sortIndex;return ie!==0?ie:I.id-F.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;a.unstable_now=function(){return c.now()}}else{var d=Date,g=d.now();a.unstable_now=function(){return d.now()-g}}var p=[],m=[],y=1,w=null,T=3,v=!1,N=!1,H=!1,R=!1,B=typeof setTimeout=="function"?setTimeout:null,X=typeof clearTimeout=="function"?clearTimeout:null,V=typeof setImmediate<"u"?setImmediate:null;function re(I){for(var F=o(m);F!==null;){if(F.callback===null)s(m);else if(F.startTime<=I)s(m),F.sortIndex=F.expirationTime,r(p,F);else break;F=o(m)}}function le(I){if(H=!1,re(I),!N)if(o(p)!==null)N=!0,_||(_=!0,$());else{var F=o(m);F!==null&&G(le,F.startTime-I)}}var _=!1,J=-1,ce=5,fe=-1;function be(){return R?!0:!(a.unstable_now()-fe<ce)}function ee(){if(R=!1,_){var I=a.unstable_now();fe=I;var F=!0;try{e:{N=!1,H&&(H=!1,X(J),J=-1),v=!0;var ie=T;try{t:{for(re(I),w=o(p);w!==null&&!(w.expirationTime>I&&be());){var ve=w.callback;if(typeof ve=="function"){w.callback=null,T=w.priorityLevel;var S=ve(w.expirationTime<=I);if(I=a.unstable_now(),typeof S=="function"){w.callback=S,re(I),F=!0;break t}w===o(p)&&s(p),re(I)}else s(p);w=o(p)}if(w!==null)F=!0;else{var E=o(m);E!==null&&G(le,E.startTime-I),F=!1}}break e}finally{w=null,T=ie,v=!1}F=void 0}}finally{F?$():_=!1}}}var $;if(typeof V=="function")$=function(){V(ee)};else if(typeof MessageChannel<"u"){var ke=new MessageChannel,ne=ke.port2;ke.port1.onmessage=ee,$=function(){ne.postMessage(null)}}else $=function(){B(ee,0)};function G(I,F){J=B(function(){I(a.unstable_now())},F)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(I){I.callback=null},a.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ce=0<I?Math.floor(1e3/I):5},a.unstable_getCurrentPriorityLevel=function(){return T},a.unstable_next=function(I){switch(T){case 1:case 2:case 3:var F=3;break;default:F=T}var ie=T;T=F;try{return I()}finally{T=ie}},a.unstable_requestPaint=function(){R=!0},a.unstable_runWithPriority=function(I,F){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var ie=T;T=I;try{return F()}finally{T=ie}},a.unstable_scheduleCallback=function(I,F,ie){var ve=a.unstable_now();switch(typeof ie=="object"&&ie!==null?(ie=ie.delay,ie=typeof ie=="number"&&0<ie?ve+ie:ve):ie=ve,I){case 1:var S=-1;break;case 2:S=250;break;case 5:S=1073741823;break;case 4:S=1e4;break;default:S=5e3}return S=ie+S,I={id:y++,callback:F,priorityLevel:I,startTime:ie,expirationTime:S,sortIndex:-1},ie>ve?(I.sortIndex=ie,r(m,I),o(p)===null&&I===o(m)&&(H?(X(J),J=-1):H=!0,G(le,ie-ve))):(I.sortIndex=S,r(p,I),N||v||(N=!0,_||(_=!0,$()))),I},a.unstable_shouldYield=be,a.unstable_wrapCallback=function(I){var F=T;return function(){var ie=T;T=F;try{return I.apply(this,arguments)}finally{T=ie}}}})(ju)),ju}var jm;function eb(){return jm||(jm=1,Hu.exports=$w()),Hu.exports}var Lu={exports:{}},ft={};var Lm;function tb(){if(Lm)return ft;Lm=1;var a=fh();function r(p){var m="https://react.dev/errors/"+p;if(1<arguments.length){m+="?args[]="+encodeURIComponent(arguments[1]);for(var y=2;y<arguments.length;y++)m+="&args[]="+encodeURIComponent(arguments[y])}return"Minified React error #"+p+"; visit "+m+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function o(){}var s={d:{f:o,r:function(){throw Error(r(522))},D:o,C:o,L:o,m:o,X:o,S:o,M:o},p:0,findDOMNode:null},h=Symbol.for("react.portal");function c(p,m,y){var w=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:h,key:w==null?null:""+w,children:p,containerInfo:m,implementation:y}}var d=a.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function g(p,m){if(p==="font")return"";if(typeof m=="string")return m==="use-credentials"?m:""}return ft.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,ft.createPortal=function(p,m){var y=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!m||m.nodeType!==1&&m.nodeType!==9&&m.nodeType!==11)throw Error(r(299));return c(p,m,null,y)},ft.flushSync=function(p){var m=d.T,y=s.p;try{if(d.T=null,s.p=2,p)return p()}finally{d.T=m,s.p=y,s.d.f()}},ft.preconnect=function(p,m){typeof p=="string"&&(m?(m=m.crossOrigin,m=typeof m=="string"?m==="use-credentials"?m:"":void 0):m=null,s.d.C(p,m))},ft.prefetchDNS=function(p){typeof p=="string"&&s.d.D(p)},ft.preinit=function(p,m){if(typeof p=="string"&&m&&typeof m.as=="string"){var y=m.as,w=g(y,m.crossOrigin),T=typeof m.integrity=="string"?m.integrity:void 0,v=typeof m.fetchPriority=="string"?m.fetchPriority:void 0;y==="style"?s.d.S(p,typeof m.precedence=="string"?m.precedence:void 0,{crossOrigin:w,integrity:T,fetchPriority:v}):y==="script"&&s.d.X(p,{crossOrigin:w,integrity:T,fetchPriority:v,nonce:typeof m.nonce=="string"?m.nonce:void 0})}},ft.preinitModule=function(p,m){if(typeof p=="string")if(typeof m=="object"&&m!==null){if(m.as==null||m.as==="script"){var y=g(m.as,m.crossOrigin);s.d.M(p,{crossOrigin:y,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0})}}else m==null&&s.d.M(p)},ft.preload=function(p,m){if(typeof p=="string"&&typeof m=="object"&&m!==null&&typeof m.as=="string"){var y=m.as,w=g(y,m.crossOrigin);s.d.L(p,y,{crossOrigin:w,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0,type:typeof m.type=="string"?m.type:void 0,fetchPriority:typeof m.fetchPriority=="string"?m.fetchPriority:void 0,referrerPolicy:typeof m.referrerPolicy=="string"?m.referrerPolicy:void 0,imageSrcSet:typeof m.imageSrcSet=="string"?m.imageSrcSet:void 0,imageSizes:typeof m.imageSizes=="string"?m.imageSizes:void 0,media:typeof m.media=="string"?m.media:void 0})}},ft.preloadModule=function(p,m){if(typeof p=="string")if(m){var y=g(m.as,m.crossOrigin);s.d.m(p,{as:typeof m.as=="string"&&m.as!=="script"?m.as:void 0,crossOrigin:y,integrity:typeof m.integrity=="string"?m.integrity:void 0})}else s.d.m(p)},ft.requestFormReset=function(p){s.d.r(p)},ft.unstable_batchedUpdates=function(p,m){return p(m)},ft.useFormState=function(p,m,y){return d.H.useFormState(p,m,y)},ft.useFormStatus=function(){return d.H.useHostTransitionStatus()},ft.version="19.2.4",ft}var _m;function nb(){if(_m)return Lu.exports;_m=1;function a(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(a)}catch(r){console.error(r)}}return a(),Lu.exports=tb(),Lu.exports}var qm;function ab(){if(qm)return vr;qm=1;var a=eb(),r=fh(),o=nb();function s(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function h(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function c(e){var t=e,n=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(n=t.return),e=t.return;while(e)}return t.tag===3?n:null}function d(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function g(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function p(e){if(c(e)!==e)throw Error(s(188))}function m(e){var t=e.alternate;if(!t){if(t=c(e),t===null)throw Error(s(188));return t!==e?null:e}for(var n=e,i=t;;){var l=n.return;if(l===null)break;var u=l.alternate;if(u===null){if(i=l.return,i!==null){n=i;continue}break}if(l.child===u.child){for(u=l.child;u;){if(u===n)return p(l),e;if(u===i)return p(l),t;u=u.sibling}throw Error(s(188))}if(n.return!==i.return)n=l,i=u;else{for(var f=!1,b=l.child;b;){if(b===n){f=!0,n=l,i=u;break}if(b===i){f=!0,i=l,n=u;break}b=b.sibling}if(!f){for(b=u.child;b;){if(b===n){f=!0,n=u,i=l;break}if(b===i){f=!0,i=u,n=l;break}b=b.sibling}if(!f)throw Error(s(189))}}if(n.alternate!==i)throw Error(s(190))}if(n.tag!==3)throw Error(s(188));return n.stateNode.current===n?e:t}function y(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=y(e),t!==null)return t;e=e.sibling}return null}var w=Object.assign,T=Symbol.for("react.element"),v=Symbol.for("react.transitional.element"),N=Symbol.for("react.portal"),H=Symbol.for("react.fragment"),R=Symbol.for("react.strict_mode"),B=Symbol.for("react.profiler"),X=Symbol.for("react.consumer"),V=Symbol.for("react.context"),re=Symbol.for("react.forward_ref"),le=Symbol.for("react.suspense"),_=Symbol.for("react.suspense_list"),J=Symbol.for("react.memo"),ce=Symbol.for("react.lazy"),fe=Symbol.for("react.activity"),be=Symbol.for("react.memo_cache_sentinel"),ee=Symbol.iterator;function $(e){return e===null||typeof e!="object"?null:(e=ee&&e[ee]||e["@@iterator"],typeof e=="function"?e:null)}var ke=Symbol.for("react.client.reference");function ne(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===ke?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case H:return"Fragment";case B:return"Profiler";case R:return"StrictMode";case le:return"Suspense";case _:return"SuspenseList";case fe:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case N:return"Portal";case V:return e.displayName||"Context";case X:return(e._context.displayName||"Context")+".Consumer";case re:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case J:return t=e.displayName||null,t!==null?t:ne(e.type)||"Memo";case ce:t=e._payload,e=e._init;try{return ne(e(t))}catch{}}return null}var G=Array.isArray,I=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,F=o.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,ie={pending:!1,data:null,method:null,action:null},ve=[],S=-1;function E(e){return{current:e}}function q(e){0>S||(e.current=ve[S],ve[S]=null,S--)}function k(e,t){S++,ve[S]=e.current,e.current=t}var P=E(null),he=E(null),oe=E(null),Ee=E(null);function Ge(e,t){switch(k(oe,t),k(he,e),k(P,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?tm(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=tm(t),e=nm(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}q(P),k(P,e)}function He(){q(P),q(he),q(oe)}function qt(e){e.memoizedState!==null&&k(Ee,e);var t=P.current,n=nm(t,e.type);t!==n&&(k(he,e),k(P,n))}function gn(e){he.current===e&&(q(P),q(he)),Ee.current===e&&(q(Ee),gr._currentValue=ie)}var Ai,Nr;function pn(e){if(Ai===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);Ai=t&&t[1]||"",Nr=-1<n.stack.indexOf(`
    at`)?" (<anonymous>)":-1<n.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Ai+e+Nr}var Da=!1;function Ia(e,t){if(!e||Da)return"";Da=!0;var n=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var i={DetermineComponentFrameRoot:function(){try{if(t){var U=function(){throw Error()};if(Object.defineProperty(U.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(U,[])}catch(O){var D=O}Reflect.construct(e,[],U)}else{try{U.call()}catch(O){D=O}e.call(U.prototype)}}else{try{throw Error()}catch(O){D=O}(U=e())&&typeof U.catch=="function"&&U.catch(function(){})}}catch(O){if(O&&D&&typeof O.stack=="string")return[O.stack,D.stack]}return[null,null]}};i.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var l=Object.getOwnPropertyDescriptor(i.DetermineComponentFrameRoot,"name");l&&l.configurable&&Object.defineProperty(i.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var u=i.DetermineComponentFrameRoot(),f=u[0],b=u[1];if(f&&b){var x=f.split(`
`),z=b.split(`
...
*Tomorrow, Sable will teach Kael how even the finest orchards need diversity to weather any storm.*`},{day:11,title:"The Balanced Garden — Portfolio Construction and Risk Management",date:"2026-03-01",image:"images/financial-independence/day-11.jpg",sonnet:`**🪶 Sonnet XI: The Balanced Garden**
...
*Tomorrow, Kael will face his greatest test yet—when winter storms threaten even the most carefully tended gardens.*`},{day:12,title:"The Storm Within — Mastering Investment Psychology",date:"2026-03-01",image:"images/financial-independence/day-12.jpg",sonnet:`**🪶 Sonnet XII: The Storm Within**
...
*Be greedy when the fearful crowd obeys.*`,standard:`💰 Day 12: The Storm Within — Mastering Investment Psychology
...
❓ **Tomorrow's Question:**
*You've mastered the psychology of market storms—but what specific metrics and financial ratios should you monitor to ensure your businesses remain healthy during economic turbulence?*`,parable:`As autumn's first storm approached the village, Kael found Sable tending his garden with unusual urgency. Dark clouds gathered overhead, promising a tempest that would test every carefully planted seed.
...
**Tomorrow**: Kael will learn the ancient art of reading nature's vital signs to distinguish between temporary storms and genuine threats to his garden's health.`}],jv=[{day:1,title:"What Is a Calorie?",date:"2026-02-28",image:"images/nutrition-science/day-1.png",sonnet:`**🪶 Sonnet I: The Measure of Fire**
...
Tomorrow, Lila would learn how this discernment could be woven into sustainable patterns that honored not just nutritional needs, but the deeper relationship between food, body, and soul.`},{day:11,title:"Sustainable Eating Patterns — Building a Lifelong Relationship with Food",date:"2026-03-01",image:"images/nutrition-science/day-11.jpg",sonnet:`**🪶 Sonnet XI: Sustainable Eating Patterns**

Like gardens that endure through every season,
Our eating patterns must bend but not break,
With roots in science, yet room for life's reason—
Flexible frameworks that wisdom will make.

Not rigid rules that crumble under pressure,
But living rhythms that dance with each day,
Where eighty percent provides health's great treasure,
And twenty percent keeps guilt and fear at bay.

The feast and famine of all-or-nothing
Destroy the peace that nourishment should bring,
While gentle consistency, ever-something,
Builds strength that helps the body's temple sing.

*True sustenance marries science with soul's art,*
*Where food feeds body, mind, and grateful heart.*`,standard:`🍎 Day 11: Sustainable Eating Patterns — Building a Lifelong Relationship with Food

Yesterday we explored nutritional discernment as our ability to cut through information overload, discovering how to evaluate sources, recognize marketing manipulation, and apply evidence-based principles to our unique circumstances. The answer to creating lasting health: sustainable eating patterns honor both our nutritional needs and our psychological relationship with food, creating harmony between science and life's realities.

🧱 **The Concept**
Sustainable eating patterns integrate nutritional science with behavioral psychology, cultural preferences, and practical constraints to create flexible frameworks that can evolve with life's changes. These patterns prioritize consistency over perfection, focusing on long-term habits that nourish both body and soul while remaining adaptable to different seasons of life.

❓ **Why It Matters**
Most diets fail because they treat food as merely fuel, ignoring the deep emotional, social, and cultural connections we have with eating. Rigid approaches often trigger all-or-nothing thinking, leading to cycles of restriction and overeating that damage both physical health and psychological well-being. Sustainable patterns recognize that lasting change comes through building positive relationships with food that can withstand stress, celebrations, travel, and life's inevitable curveballs.

⚙️ **How It Works**
**Foundation building** starts with establishing non-negotiable basics like regular meal timing, adequate protein at each meal, and including vegetables daily, while allowing flexibility in specific food choices and preparation methods. **The 80/20 principle** suggests that consistently meeting nutritional needs 80% of the time provides excellent health benefits while leaving 20% for social occasions, treats, and imperfect days without guilt or derailment. **Behavioral integration** involves linking new eating habits to existing routines — like always having protein with breakfast or preparing vegetables while cooking dinner — making healthy choices automatic rather than requiring constant willpower. **Emotional awareness** includes recognizing hunger and fullness cues, understanding the difference between physical and emotional hunger, and developing coping strategies for stress eating that don't involve restricting entire food groups. **Social sustainability** means finding ways to maintain your eating pattern during restaurants visits, family gatherings, and social events by focusing on overall balance rather than perfect adherence, communicating your needs without being rigid, and remembering that food is meant to bring people together, not create division. **Seasonal adaptation** acknowledges that optimal eating may look different during busy work periods versus vacations, summer abundance versus winter comfort foods, or different life stages like pregnancy, aging, or recovery from illness.

📖 **Definitions**
• **Intuitive eating**: Approach that emphasizes listening to internal hunger and fullness cues rather than external diet rules
• **Food flexibility**: Ability to adapt eating patterns to different circumstances without abandoning overall nutritional goals
• **Dietary adherence**: Consistency in following an eating pattern over time, more important than perfection
• **Food neutrality**: Viewing foods as neither inherently "good" nor "bad" but as choices with different nutritional profiles
• **Metabolic flexibility**: Body's ability to efficiently switch between different fuel sources based on availability and activity needs

🎯 **Science Wisdom**
The most perfect eating plan is worthless if you can't sustain it, while an imperfect plan you can follow for years will transform your health. True nourishment encompasses not just nutrients but joy, connection, and peace with your choices.

❓ **Tomorrow's Question:**
*As we complete our journey through nutrition science, how can we integrate all these principles into a personalized approach that serves our unique body, lifestyle, and long-term health goals?*`,parable:`As autumn painted the village in amber hues, Lila found Maren in her garden, carefully tending plants that had weathered the entire growing season. Some herbs stood tall and vibrant, while others showed signs of summer's trials — yet all continued to nourish.

"Master," Lila said, "I've learned to discern truth from falsehood in nutritional wisdom, but I still struggle. Sometimes I eat perfectly according to all principles, other times life overwhelms me and I abandon everything. How do I find the middle path?"

Maren smiled, brushing soil from a resilient rosemary plant. "Tell me, child, which plants in this garden have survived since spring?"

Lila studied the herbs carefully. "Not the ones that needed perfect conditions, but those that bent with storms, adapted to dry spells, and kept growing despite imperfection."

"Precisely." Maren led her to the three hearths, where a pot simmered with whatever ingredients the day had provided — some fresh vegetables, leftover grains, herbs from the garden. "This stew changes with each season, each day's harvest, each family's needs. Yet it always nourishes."

"But shouldn't I follow the exact principles we've learned?" Lila asked.

Maren ladled the fragrant stew into two bowls. "The principles are like the foundation stones of these hearths — essential and unchanging. But what you cook upon them must flow with life's rhythms. A mother feeding sick children needs different sustenance than a farmer at harvest. Winter calls for warming foods, summer for cooling ones. Celebration asks for abundance, quiet days for simplicity."

She handed Lila a bowl. "Watch how I eat this meal — with gratitude, attention, and joy, but without anxiety about its perfection. I trust the foundation we've built together. When I eat well most days, the occasional indulgence becomes part of the rhythm, not a failure."

"The travelers who visit speak of rigid food rules that rule their lives," Lila observed. "They seem more afraid of eating than nourished by it."

"Fear cannot nourish," Maren replied gently. "True wisdom lies in building patterns flexible enough to sustain you through all of life's seasons — patterns that honor both your body's needs and your soul's relationship with food. The goal is not perfection, but harmony."

As they shared the simple, imperfect, deeply satisfying meal, Lila understood. Like the resilient garden plants, sustainable nourishment came not from rigid adherence to rules, but from strong roots that allowed graceful adaptation to life's ever-changing conditions.

**Moral:** *The most nourishing eating patterns are not the most perfect, but the most sustainable — flexible enough to weather life's storms while strong enough to support lasting health.*

Tomorrow, Lila would learn to weave all these threads of wisdom into a tapestry uniquely her own.`}],Lv=[{day:1,title:"The Power of Tactical Empathy",date:"2026-03-01",image:"images/negotiation/day-1.jpg",sonnet:`**🪶 Sonnet I: The Mirror's Edge**
...
*Tomorrow, Ren would learn how even the most hostile hearts could be softened, when Vasska faced a merchant who despised all traders from their distant homeland...*`},{day:6,title:"Tactical Empathy - Mirroring Emotions to Disarm Hostility",date:"2026-03-01",image:"images/negotiation/day-6.jpg",sonnet:`**🪶 Sonnet VI: Tactical Empathy - Mirroring Emotions to Disarm Hostility**
...
*Tomorrow, Vasska will teach Ren why the most powerful word in negotiation might surprise him—and why making people comfortable with rejection can lead to unexpected acceptance.*`},{day:7,title:"The Power of No - Creating Safety Through Rejection",date:"2026-03-01",image:"images/negotiation/day-7.jpg",sonnet:`**🪶 Sonnet VII: The Power of No**
...
*You build the trust to have them give you all.*`,standard:`🤝 Day 7: The Power of No - Creating Safety Through Rejection
...
❓ **Tomorrow's Question**
*How do you anchor expectations so powerfully that even extreme positions seem reasonable by comparison?*`,parable:`The morning sun cast long shadows across the spice market as Ren approached a silk merchant's stall, clutching his coin purse with determination. He had practiced his pitch all night: persuasive words, compelling reasons, irresistible offers. But Vasska, watching from beneath a canvas awning, shook his silver head and beckoned the youth over.
...
Tomorrow, Ren would learn why the first number spoken in any negotiation holds the power to reshape reality itself.`}],_v=[{day:1,title:"The Dichotomy of Control",date:"2026-03-01",image:"images/stoic-philosophy/day-1.jpg",sonnet:`**🪶 Sonnet I: The Two Circles**
...
*Tomorrow, Caius will discover how Stoic principles apply to the practical challenges that consume most soldiers' thoughts — advancement, wealth, and security in an uncertain world.*`},{day:6,title:"The Art of Preferred Indifferents",date:"2026-03-01",image:"images/stoic-philosophy/day-6.jpg",sonnet:`**🪶 Sonnet VI: The Art of Preferred Indifferents**
...
Tomorrow, Maxima would teach Caius how even the harshest criticism could become a gift to the prepared mind...`},{day:7,title:"The Shield of Inner Worth",date:"2026-03-01",image:"images/stoic-philosophy/day-7.jpg",sonnet:`**🪶 Sonnet VII: The Shield of Inner Worth**
...
*Not others' words, however sharp their pleasure.*`,standard:`🏛️ Day 7: The Shield of Inner Worth
...
❓ **Tomorrow's Question:**
*What practical techniques do Stoics use to maintain emotional balance during overwhelming stress?*`,parable:`The morning sun cast long shadows across the training ground as Caius practiced sword forms, his movements sharp but distracted. Word had spread through the barracks about yesterday's incident — some called him a coward for refusing to join the gambling ring, others praised his discipline.
...
Tomorrow, Caius would face his greatest test yet — a moment when overwhelming pressure would threaten to shatter his philosophical resolve entirely.`}],qv=[{day:1,title:"What Is a Note? — Sound Has a Name",date:"2026-03-01",image:"images/music-theory/day-1.jpg",sonnet:`**🪶 Sonnet I: The First Vibration**
...
**Tomorrow:** Ferro taps his foot against the piano bench, and Wren discovers that harmony isn't the only thing that moves through time...`},{day:5,title:"Rhythm — The Heartbeat of Music",date:"2026-03-01",image:"images/music-theory/day-5.jpg",sonnet:`**🪶 Sonnet V: The Heartbeat of Music**
...
*And music moves the dancer through the storm.*`,standard:`🎵 Day 5: Rhythm — The Heartbeat of Music
...
*Tomorrow, she would discover how a single melodic line could contain entire worlds...*`}],Wv=[{day:1,title:"Why Real Estate Builds Wealth",date:"2026-03-01",image:"images/real-estate/day-1.jpg",sonnet:`**🪶 Sonnet I: The Land That Pays You Back**
...
*Tomorrow, Dara would learn how Hallam structured his purchases to amplify returns while protecting against disaster...*`},{day:4,title:"Financing Strategies for Maximum Returns",date:"2026-03-01",image:"images/real-estate/day-4.jpg",sonnet:`**🪶 Sonnet IV: Financing Strategies for Maximum Returns**
...
Tomorrow, Dara would learn the delicate art of managing multiple properties without drowning in their daily demands.`},{day:5,title:"Property Management Systems That Scale",date:"2026-03-01",image:"images/real-estate/day-5.jpg",sonnet:`**🪶 Sonnet V: Property Management Systems That Scale**
...
*While amateurs are chained to every stone.*`,standard:`🏠 Day 5: Property Management Systems That Scale
...
❓ **Tomorrow's Question:**
*How do market cycles affect real estate values, and how can investors position themselves to profit from both up and down markets?*`,parable:`As autumn painted the village in gold, Dara found herself overwhelmed. Her three rental cottages demanded constant attention—loose shutters here, late rent there, complaints about neighbors everywhere. She spent more time managing properties than building new ones.
...
Tomorrow, Dara would learn how Hallam had survived the great market upheaval of twenty years past, when half the village's property values crumbled—yet somehow, he had emerged wealthier than before.`}],Yv=[{day:1,title:"The Hook — Why Stories Grab You",date:"2026-03-01",image:"images/storytelling/day-1.jpg",sonnet:`**🪶 Sonnet I: The Unfinished Thread**
...
*Tomorrow, Pip will discover why even the most compelling characters need something more — the invisible force that transforms peaceful scenes into edge-of-your-seat tension...*`},{day:4,title:"The Invisible Hand — Mastering Tension and Suspense",date:"2026-03-01",image:"images/storytelling/day-4.jpg",sonnet:`**🪶 Sonnet IV: The Invisible Hand**
...
*Tomorrow, Osha will teach Pip why some threads must be pulled quickly and others slowly, revealing the secret rhythm that makes stories breathe...*`},{day:5,title:"The Conductor's Baton — Mastering Pacing and Rhythm",date:"2026-03-01",image:"images/storytelling/day-5.jpg",sonnet:`**🪶 Sonnet V: The Conductor's Baton**
...
*Rush past the trivial, let meaning sail.*`,standard:`📖 Day 5: The Conductor's Baton — Mastering Pacing and Rhythm
...
❓ **Tomorrow's Question:**
*We've mastered the rhythm of story, but what about the voices within it? How do we make characters speak so distinctly that readers could identify them blindfolded?*`,parable:`Pip sat cross-legged beneath Osha's loom, watching her weathered fingers dance across the threads with impossible precision — sometimes flying like hummingbirds, sometimes moving with the deliberate grace of falling snow.
...
*Tomorrow, Osha will teach Pip why every character must speak with their own voice...*`}],Uv=[{day:1,title:"Bids for Connection — The Smallest Unit of Love",date:"2026-03-01",image:"images/building-relationships/day-1.jpg",sonnet:`**🪶 Sonnet I: The Turning Toward**
...
*Tomorrow, we shall discover how Elder Rynn teaches travelers to stay close even when emotions run as wild as winter storms...*`},{day:4,title:"Emotional Attunement — Staying Connected Through the Storm",date:"2026-03-01",image:"images/building-relationships/day-4.jpg",sonnet:`**🪶 Sonnet IV: Emotional Attunement**
...
*Tomorrow, Elder Rynn will reveal how the Bridge of Vows is built one stone of trust at a time...*`},{day:5,title:"The Architecture of Trust — Building Safety Brick by Brick",date:"2026-03-01",image:"images/building-relationships/day-5.jpg",sonnet:`**🪶 Sonnet V: The Architecture of Trust**
...
*Trust built by daily choice, brick by brick, sound.*`,standard:`💕 Day 5: The Architecture of Trust — Building Safety Brick by Brick
...
❓ **Tomorrow's Question:**
*How do couples maintain their individual identity and personal growth while building a life together?*`,parable:`As Ash and Lume approached the Bridge of Vows, they found Elder Rynn carefully placing stones into its foundation. Years of weather and countless crossings had worn some supports thin, and the ancient keeper worked with methodical precision.
...
`});const m={type:"element",tagName:"li",properties:c,children:d};return a.patch(r,m),a.applyData(r,m)}function iS(a){let r=!1;if(a.type==="list"){r=a.spread||!1;const o=a.children;let s=-1;for(;!r&&++s<o.length;)r=Mp(o[s])}return r}function Mp(a){const r=a.spread;return r??a.children.length>1}function rS(a,r){const o={},s=a.all(r);let h=-1;for(typeof r.start=="number"&&r.start!==1&&(o.start=r.start);++h<s.length;){const d=s[h];if(d.type==="element"&&d.tagName==="li"&&d.properties&&Array.isArray(d.properties.className)&&d.properties.className.includes("task-list-item")){o.className=["contains-task-list"];break}}const c={type:"element",tagName:r.ordered?"ol":"ul",properties:o,children:a.wrap(s,!0)};return a.patch(r,c),a.applyData(r,c)}function oS(a,r){const o={type:"element",tagName:"p",properties:{},children:a.all(r)};return a.patch(r,o),a.applyData(r,o)}function sS(a,r){const o={type:"root",children:a.wrap(a.all(r))};return a.patch(r,o),a.applyData(r,o)}function lS(a,r){const o={type:"element",tagName:"strong",properties:{},children:a.all(r)};return a.patch(r,o),a.applyData(r,o)}function uS(a,r){const o=a.all(r),s=o.shift(),h=[];if(s){const d={type:"element",tagName:"thead",properties:{},children:a.wrap([s],!0)};a.patch(r.children[0],d),h.push(d)}if(o.length>0){const d={type:"element",tagName:"tbody",properties:{},children:a.wrap(o,!0)},g=Sh(r.children[1]),p=lp(r.children[r.children.length-1]);g&&p&&(d.position={start:g,end:p}),h.push(d)}const c={type:"element",tagName:"table",properties:{},children:a.wrap(h,!0)};return a.patch(r,c),a.applyData(r,c)}function hS(a,r,o){const s=o?o.children:void 0,c=(s?s.indexOf(r):1)===0?"th":"td",d=o&&o.type==="table"?o.align:void 0,g=d?d.length:r.children.length;let p=-1;const m=[];for(;++p<g;){const w=r.children[p],T={},v=d?d[p]:void 0;v&&(T.align=v);let N={type:"element",tagName:c,properties:T,children:[]};w&&(N.children=a.all(w),a.patch(w,N),N=a.applyData(w,N)),m.push(N)}const y={type:"element",tagName:"tr",properties:{},children:a.wrap(m,!0)};return a.patch(r,y),a.applyData(r,y)}function cS(a,r){const o={type:"element",tagName:"td",properties:{},children:a.all(r)};return a.patch(r,o),a.applyData(r,o)}const yg=9,wg=32;function dS(a){const r=String(a),o=/\r?\n|\r/g;let s=o.exec(r),h=0;const c=[];for(;s;)c.push(bg(r.slice(h,s.index),h>0,!0),s[0]),h=s.index+s[0].length,s=o.exec(r);return c.push(bg(r.slice(h),h>0,!1)),c.join("")}function bg(a,r,o){let s=0,h=a.length;if(r){let c=a.codePointAt(s);for(;c===yg||c===wg;)s++,c=a.codePointAt(s)}if(o){let c=a.codePointAt(h-1);for(;c===yg||c===wg;)h--,c=a.codePointAt(h-1)}return h>s?a.slice(s,h):""}function fS(a,r){const o={type:"text",value:dS(String(r.value))};return a.patch(r,o),a.applyData(r,o)}function mS(a,r){const o={type:"element",tagName:"hr",properties:{},children:[]};return a.patch(r,o),a.applyData(r,o)}const gS={blockquote:V0,break:F0,code:G0,delete:Q0,emphasis:X0,footnoteReference:K0,heading:Z0,html:J0,imageReference:P0,image:$0,inlineCode:eS,linkReference:tS,link:nS,listItem:aS,list:rS,paragraph:oS,root:sS,strong:lS,table:uS,tableCell:cS,tableRow:hS,text:fS,thematicBreak:mS,toml:ns,yaml:ns,definition:ns,footnoteDefinition:ns};function ns(){}const zp=-1,ps=0,Mr=1,hs=2,Dh=3,Ih=4,Rh=5,Bh=6,Dp=7,Ip=8,vg=typeof self=="object"?self:globalThis,pS=(a,r)=>{const o=(h,c)=>(a.set(c,h),h),s=h=>{if(a.has(h))return a.get(h);const[c,d]=r[h];switch(c){case ps:case zp:return o(d,h);case Mr:{const g=o([],h);for(const p of d)g.push(s(p));return g}case hs:{const g=o({},h);for(const[p,m]of d)g[s(p)]=s(m);return g}case Dh:return o(new Date(d),h);case Ih:{const{source:g,flags:p}=d;return o(new RegExp(g,p),h)}case Rh:{const g=o(new Map,h);for(const[p,m]of d)g.set(s(p),s(m));return g}case Bh:{const g=o(new Set,h);for(const p of d)g.add(s(p));return g}case Dp:{const{name:g,message:p}=d;return o(new vg[g](p),h)}case Ip:return o(BigInt(d),h);case"BigInt":return o(Object(BigInt(d)),h);case"ArrayBuffer":return o(new Uint8Array(d).buffer,d);case"DataView":{const{buffer:g}=new Uint8Array(d);return o(new DataView(g),d)}}return o(new vg[c](d),h)};return s},kg=a=>pS(new Map,a)(0),bi="",{toString:yS}={},{keys:wS}=Object,Er=a=>{const r=typeof a;if(r!=="object"||!a)return[ps,r];const o=yS.call(a).slice(8,-1);switch(o){case"Array":return[Mr,bi];case"Object":return[hs,bi];case"Date":return[Dh,bi];case"RegExp":return[Ih,bi];case"Map":return[Rh,bi];case"Set":return[Bh,bi];case"DataView":return[Mr,o]}return o.includes("Array")?[Mr,o]:o.includes("Error")?[Dp,o]:[hs,o]},as=([a,r])=>a===ps&&(r==="function"||r==="symbol"),bS=(a,r,o,s)=>{const h=(d,g)=>{const p=s.push(d)-1;return o.set(g,p),p},c=d=>{if(o.has(d))return o.get(d);let[g,p]=Er(d);switch(g){case ps:{let y=d;switch(p){case"bigint":g=Ip,y=d.toString();break;case"function":case"symbol":if(a)throw new TypeError("unable to serialize "+p);y=null;break;case"undefined":return h([zp],d)}return h([g,y],d)}case Mr:{if(p){let T=d;return p==="DataView"?T=new Uint8Array(d.buffer):p==="ArrayBuffer"&&(T=new Uint8Array(d)),h([p,[...T]],d)}const y=[],w=h([g,y],d);for(const T of d)y.push(c(T));return w}case hs:{if(p)switch(p){case"BigInt":return h([p,d.toString()],d);case"Boolean":case"Number":case"String":return h([p,d.valueOf()],d)}if(r&&"toJSON"in d)return c(d.toJSON());const y=[],w=h([g,y],d);for(const T of wS(d))(a||!as(Er(d[T])))&&y.push([c(T),c(d[T])]);return w}case Dh:return h([g,d.toISOString()],d);case Ih:{const{source:y,flags:w}=d;return h([g,{source:y,flags:w}],d)}case Rh:{const y=[],w=h([g,y],d);for(const[T,v]of d)(a||!(as(Er(T))||as(Er(v))))&&y.push([c(T),c(v)]);return w}case Bh:{const y=[],w=h([g,y],d);for(const T of d)(a||!as(Er(T)))&&y.push(c(T));return w}}const{message:m}=d;return h([g,{name:p,message:m}],d)};return c},Tg=(a,{json:r,lossy:o}={})=>{const s=[];return bS(!(r||o),!!r,new Map,s)(a),s},cs=typeof structuredClone=="function"?(a,r)=>r&&("json"in r||"lossy"in r)?kg(Tg(a,r)):structuredClone(a):(a,r)=>kg(Tg(a,r));function vS(a,r){const o=[{type:"text",value:"↩"}];return r>1&&o.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(r)}]}),o}function kS(a,r){return"Back to reference "+(a+1)+(r>1?"-"+r:"")}function TS(a){const r=typeof a.options.clobberPrefix=="string"?a.options.clobberPrefix:"user-content-",o=a.options.footnoteBackContent||vS,s=a.options.footnoteBackLabel||kS,h=a.options.footnoteLabel||"Footnotes",c=a.options.footnoteLabelTagName||"h2",d=a.options.footnoteLabelProperties||{className:["sr-only"]},g=[];let p=-1;for(;++p<a.footnoteOrder.length;){const m=a.footnoteById.get(a.footnoteOrder[p]);if(!m)continue;const y=a.all(m),w=String(m.identifier).toUpperCase(),T=Ei(w.toLowerCase());let v=0;const N=[],H=a.footnoteCounts.get(w);for(;H!==void 0&&++v<=H;){N.length>0&&N.push({type:"text",value:" "});let X=typeof o=="string"?o:o(p,v);typeof X=="string"&&(X={type:"text",value:X}),N.push({type:"element",tagName:"a",properties:{href:"#"+r+"fnref-"+T+(v>1?"-"+v:""),dataFootnoteBackref:"",ariaLabel:typeof s=="string"?s:s(p,v),className:["data-footnote-backref"]},children:Array.isArray(X)?X:[X]})}const R=y[y.length-1];if(R&&R.type==="element"&&R.tagName==="p"){const X=R.children[R.children.length-1];X&&X.type==="text"?X.value+=" ":R.children.push({type:"text",value:" "}),R.children.push(...N)}else y.push(...N);const B={type:"element",tagName:"li",properties:{id:r+"fn-"+T},children:a.wrap(y,!0)};a.patch(m,B),g.push(B)}if(g.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:c,properties:{...cs(d),id:"footnote-label"},children:[{type:"text",value:h}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:a.wrap(g,!0)},{type:"text",value:`
`}]}}const Rp=(function(a){if(a==null)return AS;if(typeof a=="function")return ys(a);if(typeof a=="object")return Array.isArray(a)?SS(a):xS(a);if(typeof a=="string")return ES(a);throw new Error("Expected function, string, or object as test")});function SS(a){const r=[];let o=-1;for(;++o<a.length;)r[o]=Rp(a[o]);return ys(s);function s(...h){let c=-1;for(;++c<r.length;)if(r[c].apply(this,h))return!0;return!1}}function xS(a){const r=a;return ys(o);function o(s){const h=s;let c;for(c in a)if(h[c]!==r[c])return!1;return!0}}function ES(a){return ys(r);function r(o){return o&&o.type===a}}function ys(a){return r;function r(o,s,h){return!!(CS(o)&&a.call(this,o,typeof s=="number"?s:void 0,h||void 0))}}function AS(){return!0}function CS(a){return a!==null&&typeof a=="object"&&"type"in a}const Bp=[],MS=!0,Sg=!1,zS="skip";function DS(a,r,o,s){let h;typeof r=="function"&&typeof o!="function"?(s=o,o=r):h=r;const c=Rp(h),d=s?-1:1;g(a,void 0,[])();function g(p,m,y){const w=p&&typeof p=="object"?p:{};if(typeof w.type=="string"){const v=typeof w.tagName=="string"?w.tagName:typeof w.name=="string"?w.name:void 0;Object.defineProperty(T,"name",{value:"node ("+(p.type+(v?"<"+v+">":""))+")"})}return T;function T(){let v=Bp,N,H,R;if((!r||c(p,m,y[y.length-1]||void 0))&&(v=IS(o(p,y)),v[0]===Sg))return v;if("children"in p&&p.children){const B=p;if(B.children&&v[0]!==zS)for(H=(s?B.children.length:-1)+d,R=y.concat(B);H>-1&&H<B.children.length;){const X=B.children[H];if(N=g(X,H,R)(),N[0]===Sg)return N;H=typeof N[1]=="number"?N[1]:H+d}}return v}}}function IS(a){return Array.isArray(a)?a:typeof a=="number"?[MS,a]:a==null?Bp:[a]}function Op(a,r,o,s){let h,c,d;typeof r=="function"&&typeof o!="function"?(c=void 0,d=r,h=o):(c=r,d=o,h=s),DS(a,c,g,h);function g(p,m){const y=m[m.length-1],w=y?y.children.indexOf(p):void 0;return d(p,w,y)}}const hh={}.hasOwnProperty,RS={};function BS(a,r){const o=r||RS,s=new Map,h=new Map,c=new Map,d={...gS,...o.handlers},g={all:m,applyData:NS,definitionById:s,footnoteById:h,footnoteCounts:c,footnoteOrder:[],handlers:d,one:p,options:o,patch:OS,wrap:jS};return Op(a,function(y){if(y.type==="definition"||y.type==="footnoteDefinition"){const w=y.type==="definition"?s:h,T=String(y.identifier).toUpperCase();w.has(T)||w.set(T,y)}}),g;function p(y,w){const T=y.type,v=g.handlers[T];if(hh.call(g.handlers,T)&&v)return v(g,y,w);if(g.options.passThrough&&g.options.passThrough.includes(T)){if("children"in y){const{children:H,...R}=y,B=cs(R);return B.children=g.all(y),B}return cs(y)}return(g.options.unknownHandler||HS)(g,y,w)}function m(y){const w=[];if("children"in y){const T=y.children;let v=-1;for(;++v<T.length;){const N=g.one(T[v],y);if(N){if(v&&T[v-1].type==="break"&&(!Array.isArray(N)&&N.type==="text"&&(N.value=xg(N.value)),!Array.isArray(N)&&N.type==="element")){const H=N.children[0];H&&H.type==="text"&&(H.value=xg(H.value))}Array.isArray(N)?w.push(...N):w.push(N)}}}return w}}function OS(a,r){a.position&&(r.position=yk(a))}function NS(a,r){let o=r;if(a&&a.data){const s=a.data.hName,h=a.data.hChildren,c=a.data.hProperties;if(typeof s=="string")if(o.type==="element")o.tagName=s;else{const d="children"in o?o.children:[o];o={type:"element",tagName:s,properties:{},children:d}}o.type==="element"&&c&&Object.assign(o.properties,cs(c)),"children"in o&&o.children&&h!==null&&h!==void 0&&(o.children=h)}return o}function HS(a,r){const o=r.data||{},s="value"in r&&!(hh.call(o,"hProperties")||hh.call(o,"hChildren"))?{type:"text",value:r.value}:{type:"element",tagName:"div",properties:{},children:a.all(r)};return a.patch(r,s),a.applyData(r,s)}function jS(a,r){const o=[];let s=-1;for(r&&o.push({type:"text",value:`
